...
namespace Path
{
    ...
    std::string Combine(const std::string_view& a, const std::string_view& b);

    template<typename... Args> static std::string Combine(const std::string_view& a, const std::string_view& b, Args... args)
    {
