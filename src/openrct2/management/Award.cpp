...
namespace Awards
{
    namespace Checks
    {
        ...
        static bool MostUntidy(sint32 awardType, sint32 activeAwardTypes)
        {
        ...
        static bool MostTidy(sint32 awardType, sint32 activeAwardTypes)
        {
        ...
        static bool BestRollercoasters(sint32 awardType, sint32 activeAwardTypes)
        {
        ...
        static bool BestValue(sint32 awardType, sint32 activeAwardTypes)
        {
        ...
        static bool MostBeautiful(sint32 awardType, sint32 activeAwardTypes)
        {
            if (activeAwardTypes & (1 << PARK_AWARD_MOST_UNTIDY)) return 0;
            if (activeAwardTypes & (1 << PARK_AWARD_MOST_DISAPPOINTING)) return 0;
        ...
        static bool WorseValue(sint32 awardType, sint32 activeAwardTypes)
        {
        ...
        static bool Safest(sint32 awardType, sint32 activeAwardTypes)
        {
        ...
        static bool BestStaff(sint32 awardType, sint32 activeAwardTypes)
        {
        ...
        static bool BestFood(sint32 awardType, sint32 activeAwardTypes)
        {
        ...
        static bool WorstFood(sint32 awardType, sint32 activeAwardTypes)
        {
        ...
        static bool BestRestrooms(sint32 awardType, sint32 activeAwardTypes)
        {
        ...
        static bool MostDisappointing(sint32 awardType, sint32 activeAwardTypes)
        {
            if (activeAwardTypes & (1 << PARK_AWARD_BEST_VALUE))
            {
                return 0;
        ...
        static bool BestWaterRides(sint32 awardType, sint32 activeAwardTypes)
        {
            sint32 waterRides = 0;
        ...
        static bool BestCustomDesignedRides(sint32 awardType, sint32 activeAwardTypes)
        {
        ...
        static bool MostDazzlingRideColours(sint32 awardType, sint32 activeAwardTypes)
        {
        ...
        static bool MostConfusingLayout(sint32 awardType, sint32 activeAwardTypes)
        {
        ...
        static bool BestGentleRides(sint32 awardType, sint32 activeAwardTypes)
        {
    ...
    {
        { Checks::MostUntidy,               SPR_AWARD_MOST_UNTIDY,                  STR_AWARD_MOST_UNTIDY,                  STR_NEWS_ITEM_AWARD_MOST_UNTIDY,            NEGATIVE },
        { Checks::MostTidy,                 SPR_AWARD_MOST_TIDY,                    STR_AWARD_MOST_TIDY,                    STR_NEWS_ITEM_MOST_TIDY,                    POSITIVE },
        { Checks::BestRollercoasters,       SPR_AWARD_BEST_ROLLERCOASTERS,          STR_AWARD_BEST_ROLLERCOASTERS,          STR_NEWS_ITEM_BEST_ROLLERCOASTERS,          POSITIVE },
        { Checks::BestValue,                SPR_AWARD_BEST_VALUE,                   STR_AWARD_BEST_VALUE,                   STR_NEWS_ITEM_BEST_VALUE,                   POSITIVE },
        { Checks::MostBeautiful,            SPR_AWARD_MOST_BEAUTIFUL,               STR_AWARD_MOST_BEAUTIFUL,               STR_NEWS_ITEM_MOST_BEAUTIFUL,               POSITIVE },
        { Checks::WorseValue,               SPR_AWARD_WORST_VALUE,                  STR_AWARD_WORST_VALUE,                  STR_NEWS_ITEM_WORST_VALUE,                  NEGATIVE },
        { Checks::Safest,                   SPR_AWARD_SAFEST,                       STR_AWARD_SAFEST,                       STR_NEWS_ITEM_SAFEST,                       POSITIVE },
        { Checks::BestStaff,                SPR_AWARD_BEST_STAFF,                   STR_AWARD_BEST_STAFF,                   STR_NEWS_ITEM_BEST_STAFF,                   POSITIVE },
        { Checks::BestFood,                 SPR_AWARD_BEST_FOOD,                    STR_AWARD_BEST_FOOD,                    STR_NEWS_ITEM_BEST_FOOD,                    POSITIVE },
        { Checks::WorstFood,                SPR_AWARD_WORST_FOOD,                   STR_AWARD_WORST_FOOD,                   STR_NEWS_ITEM_WORST_FOOD,                   NEGATIVE },
        { Checks::BestRestrooms,            SPR_AWARD_BEST_RESTROOMS,               STR_AWARD_BEST_RESTROOMS,               STR_NEWS_ITEM_BEST_RESTROOMS,               POSITIVE },
        { Checks::MostDisappointing,        SPR_AWARD_MOST_DISAPPOINTING,           STR_AWARD_MOST_DISAPPOINTING,           STR_NEWS_ITEM_MOST_DISAPPOINTING,           NEGATIVE },
        { Checks::BestWaterRides,           SPR_AWARD_BEST_WATER_RIDES,             STR_AWARD_BEST_WATER_RIDES,             STR_NEWS_ITEM_BEST_WATER_RIDES,             POSITIVE },
        { Checks::BestCustomDesignedRides,  SPR_AWARD_BEST_CUSTOM_DESIGNED_RIDES,   STR_AWARD_BEST_CUSTOM_DESIGNED_RIDES,   STR_NEWS_ITEM_BEST_CUSTOM_DESIGNED_RIDES,   POSITIVE },
        { Checks::MostDazzlingRideColours,  SPR_AWARD_MOST_DAZZLING_RIDE_COLOURS,   STR_AWARD_MOST_DAZZLING_RIDE_COLOURS,   STR_NEWS_ITEM_MOST_DAZZLING_RIDE_COLOURS,   POSITIVE },
        { Checks::MostConfusingLayout,      SPR_AWARD_MOST_CONFUSING_LAYOUT,        STR_AWARD_MOST_CONFUSING_LAYOUT,        STR_NEWS_ITEM_MOST_CONFUSING_LAYOUT,        NEGATIVE },
        { Checks::BestGentleRides,          SPR_AWARD_BEST_GENTLE_RIDES,            STR_AWARD_BEST_GENTLE_RIDES,            STR_NEWS_ITEM_BEST_GENTLE_RIDES,            POSITIVE },
    };
